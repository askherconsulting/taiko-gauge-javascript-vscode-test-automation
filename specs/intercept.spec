...
* Respond to "https://docs.gauge.org/writing-specifications.html" with "mocked specifications page"
...
* Respond to "https://docs.gauge.org/writing-specifications.html" with json "[\"mocked\",\"specifications\",\"page\"]"
* Navigate to "https://docs.gauge.org"
* Click an element that contains "Write Specifications"
* Assert text "[\"mocked\",\"specifications\",\"page\"]" exists on the page.
